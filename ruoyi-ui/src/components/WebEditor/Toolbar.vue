<template>
  <div>
    <div :class="isDarkMode ? 'dark toolbar' : 'toolbar'">
      ...
      <el-button style="margin-left: 10px;" type="primary" @click="preview(false)">预览</el-button>
...
import toast from '@/utils/web-editor/toast'
import {mapState} from 'vuex'
import Preview from '@/components/WebEditor/Editor/Preview'
import AceEditor from '@/components/WebEditor/Editor/AceEditor.vue'
...
} from '@/utils/web-editor/changeComponentsSizeWithScale'
...
export default {
  ...
  data() {
    return {
      ...
      uploadImgUrl:  "/common/upload", // 上传的图片服务器地址
      headers: {
  ...
  methods: {
    ...
    handleFileChange(e) {
      ...
      request({
        ...
        img.onload = () => {
          ...
          that.$store.commit('addComponent', {component})
    ...
    save() {
       this.$emit('saveData', this.componentData, this.canvasStyleData)
    },
