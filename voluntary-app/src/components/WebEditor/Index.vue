...
<script>
import Editor from '@/components//WebEditor/Editor/index'
import ComponentList from '@/components/WebEditor/ComponentList' // 左侧列表组件
import AnimationList from '@/components/WebEditor/AnimationList' // 右侧动画列表
import EventList from '@/components/WebEditor/EventList' // 右侧事件列表
import componentList from '@/components/WebEditor/custom-component/component-list' // 左侧列表数据
import Toolbar from '@/components/WebEditor/Toolbar'
import { deepCopy } from '@/utils/web-editor/utils'
import { mapState } from 'vuex'
import generateID from '@/utils/web-editor/generateID'
import { listenGlobalKeyDown } from '@/utils/web-editor/shortcutKey'
import RealTimeComponentList from '@/components/WebEditor/RealTimeComponentList'
import CanvasAttr from '@/components/WebEditor/CanvasAttr'
import { changeComponentSizeWithScale } from '@/utils/web-editor/changeComponentsSizeWithScale'
import { setDefaultcomponentData } from '@/store/editor/snapshot'
...
export default {
    ...
    methods: {
        saveData(canvasData, canvasStyle ) {
            this.$emit('handleSave', { canvasData:canvasData, canvasStyle:canvasStyle })
        },
        restore() {
            // 用保存的数据恢复画布
            if (localStorage.getItem('canvasData')&& localStorage.getItem('canvasData')!='undefined') {
            ...
            if (localStorage.getItem('canvasStyle') && localStorage.getItem('canvasStyle')!='undefined') {
